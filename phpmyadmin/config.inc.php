...
$i++;
$cfg['Servers'][$i]['host']          = 'mydb.ics.purdue.edu'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['user']          = 'rugby';      // MySQL user
$cfg['Servers'][$i]['password']      = 'password';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'rugby';          // If set to a db-name, only
